...
class LetterController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.karyawan.letter.create',[
    ...
    public function incoming_mail()
    {
        ...
        return view('pages.karyawan.letter.incoming');
    }
    ...
    public function outgoing_mail()
    {
        ...
        return view('pages.karyawan.letter.outgoing');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.karyawan.letter.show',[
            'item' => $item,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.karyawan.letter.edit',[
            'departments' => $departments,
            'senders' => $senders,
            'item' => $item,
        ]);
