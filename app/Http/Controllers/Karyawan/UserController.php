...
class UserController extends Controller
{
    public function index()
    {
        ...
        return view('pages.karyawan.user.index');
    }

    public function create()
    {
        return view('pages.karyawan.user.create');
    }
    ...
    public function show($id)
    {
        ...
        return response()->view('pages.admin.user.index', [
            'user' => $user
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.karyawan.user.edit',[
            'item' => $item
        ]);
    }
    ...
    {
        return view('pages.karyawan.user.change-password');
    }
