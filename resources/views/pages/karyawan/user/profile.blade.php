    ...
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link {{ (request()->is('karyawan/setting')) ? 'active ms-0' : '' }}" href="{{ route('setting.index') }}">Profil</a>
                <a class="nav-link {{ (request()->is('karyawan/setting/change-password')) ? 'active ms-0' : '' }}" href="{{ route('change-password') }}">Ubah Password</a>
            </nav>
            <hr class="mt-0 mb-4" />
            <div class="row">
                <div class="col">
