                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Karyawan Panel</div>
                        </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body h-100 p-5">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid" src="/karyawan/assets/img/illustrations/at-work.svg" style="max-width: 26rem" /></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="me-3">
                                    ...
                                    <div class="text-lg fw-bold">{{ $suratMasuk }}</div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="me-3">
                                    ...
                                    <div class="text-lg fw-bold">{{ $suratKeluar }}</div>
                                </div>
                                <i class="feather-xl text-white-50" data-feather="mail"></i>
                            </div>
                        </div>
