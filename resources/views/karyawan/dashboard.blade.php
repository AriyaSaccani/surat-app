...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Halaman Karyawan" />
        <meta name="author" content="AlFatih Developer" />
    ...
    <body class="nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_nav">
                @include('includes.sidebar-admin') <!-- Sidebar tetap digunakan untuk admin -->
            </div>
